...
def set_user():
    ...
    try:
        ...
        print("Полученные данные:", data)  # Логирование входных данных
...
def update_user():
    try:
        data = request.get_json()
        print("Полученные данные для обновления:", data)  # Логирование данных
        ...
        users[user_id].update(data.get("update_data", {}))
        save_users()
